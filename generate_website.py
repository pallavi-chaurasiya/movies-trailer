...
dark_knight = Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTk4ODQzNDY3Ml5BMl5BanBnXkFtZTcwODA0NTM4Nw@@._V1_QL50_.jpg",  # NOQA
...
fight_club = Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BZGY5Y2RjMmItNDg5Yy00NjUwLThjMTEtNDc2OGUzNTBiYmM1XkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_QL50_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=BdJKm16Co6M"  # NOQA
    )
...
prestige = Movie(
    "The Prestige",
    "Two stage magicians engage in competitive one-upmanship in an attempt to "
    "create the ultimate stage illusion.",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMjA4NDI0MTIxNF5BMl5BanBnXkFtZTYwNTM0MzY2._V1_QL50_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=DHoXum3M9eE"  # NOQA
    )
...
django_unchained = Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMjIyNTQ5NjQ1OV5BMl5BanBnXkFtZTcwODg1MDU4OA@@._V1_QL50_SY1000_CR0,0,674,1000_AL_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=_iH0UBYDI4g"  # NOQA
    )
...
# Call to a function to generate html from the list of the movies passed to it
